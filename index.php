  ...
  <section class="featuredwork">
    ...
    <div class="commonworkrow mba">
      <a href="/work/mary-baldwin-mba" class="text-holder w-inline-block">
        <div class="workcontent textwhite _1300">
          <div class="tinytext">Mary Baldwin University</div>
          <h2>Kickstarting a revolutionary Business Administration (MBA) Program.</h2>
        </div>
      </a>
    </div>
    ...
    <a data-w-id="29223a35-dca6-515f-03b1-71d0a0870080" href="/work" class="sectionlink backgroundblack w-inline-block">
      <div class="w-layout-blockcontainer _1300 w-container">
        ...
        <div class="w-layout-hflex commonflexwide">
          <h2 data-w-id="690192b9-994c-689f-b642-2ac09e318ae8" style="opacity:0">View Portfolio &amp; Featured Work.</h2><img src="wp-content/themes/commontheme2025/images/commonarrow.svg" loading="lazy" alt="" class="movearrow">
        </div>
      </div>
    </a>
  </section>
