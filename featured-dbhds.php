<?php
/**
 * Template Name: Featured DBHDS Template
 *
...
<div data-w-id="1b86668c-e88c-9062-1a5f-b2b8ae333225" style="opacity:0" class="featuredcard common-card backgrounddark"><img loading="lazy" src="/wp-content/themes/commontheme/images/commonwealth-creative-dbhds-logo-white.svg" alt="Mary Baldwin University Seal" class="logoimg">
...
<h2 class="tinytext">Strategies &amp; Methods</h2>
      ...
      <ul role="list" class="workspagelist">
        ...
        <li class="serviceslist">Windows Azure</li>
        <li class="serviceslist">Windows 10 & 11 Server</li>
        <li class="serviceslist">Microsoft 365</li>
        <li class="serviceslist">Azure DevOps</li>
        <li class="serviceslist">ServiceNow</li>
        <li class="serviceslist">Power Automate</li>
        <li class="serviceslist">Apache</li>
        <li class="serviceslist">WAMP/MAMP</li>
...
<div class="horizontal-scroll-wrapper">
  <div class="horizontal-scroll-content">
    <!-- 1 --><a href="#" data-cal-link="hello.mattsmall/15min" data-cal-namespace="" data-cal-config='{"layout":"month_view"}' data-w-id="990f7fe4-5691-b0c5-4e94-fe5c84af84b2" class="section featured first w-inline-block"><img class="featureimg" src="/wp-content/themes/commontheme/images/work-commonwealth-creative-dbhds-1_1.webp" alt="" style="opacity:0" sizes="(max-width: 479px) 100vw, (max-width: 767px) 62.6875px, (max-width: 991px) 29vw, 65vw" data-w-id="990f7fe4-5691-b0c5-4e94-fe5c84af84b3" loading="lazy"></a><!-- 1 -->
    ...
    <!-- 3 --><a href="#" data-cal-link="hello.mattsmall/15min" data-cal-namespace="" data-cal-config='{"layout":"month_view"}' data-w-id="f97acba5-7ae4-1471-9c74-d6c82064a7d7" class="section featured w-inline-block"><img class="featureimg" src="/wp-content/themes/commontheme/images/work-commonwealth-creative-dbhds-3_1.webp" alt="" style="opacity:0" sizes="(max-width: 479px) 79vw, (max-width: 767px) 87vw, (max-width: 991px) 90vw, 65vw" data-w-id="f97acba5-7ae4-1471-9c74-d6c82064a7d8" loading="lazy"></a><!-- 3 -->
    <!-- 4 --><a href="#" data-cal-link="hello.mattsmall/15min" data-cal-namespace="" data-cal-config='{"layout":"month_view"}' data-w-id="bc7a3d93-7e69-ea0d-52f3-03a55138b989" class="section featured w-inline-block"><img class="featureimg" src="/wp-content/themes/commontheme/images/work-commonwealth-creative-dbhds-4_1.webp" alt="" style="opacity:0" sizes="(max-width: 479px) 79vw, (max-width: 767px) 87vw, (max-width: 991px) 90vw, 65vw" data-w-id="bc7a3d93-7e69-ea0d-52f3-03a55138b98a" loading="lazy"></a><!-- 4 -->
    <!-- 5 --><a href="#" data-cal-link="hello.mattsmall/15min" data-cal-namespace="" data-cal-config='{"layout":"month_view"}' data-w-id="e6f4876e-cf7c-b96f-6b87-c269130a7ac0" class="section featured w-inline-block"><img class="featureimg" src="/wp-content/themes/commontheme/images/work-commonwealth-creative-dbhds-5_1.webp" alt="" style="opacity:0" sizes="(max-width: 479px) 79vw, (max-width: 767px) 87vw, (max-width: 991px) 90vw, 65vw" data-w-id="e6f4876e-cf7c-b96f-6b87-c269130a7ac1" loading="lazy"></a><!-- 5 -->
