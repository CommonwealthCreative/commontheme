<?php
/**
 * Template Name: Featured NOVA-FR Template
 *
...
<div data-w-id="1b86668c-e88c-9062-1a5f-b2b8ae333225" style="opacity:0" class="featuredcard common-card backgroundlite"><img loading="lazy" src="/wp-content/themes/commontheme/images/commonwealth-creative-northern-virginia-food-rescue.svg" alt="Mary Baldwin University Seal" class="logoimg">
...
<?php the_title( ' <h1 class="mid paytone">', '</h1>' ); ?>
  ...
  <h2 class="tinytext">Strategies &amp; Methods</h2>
      ...
      <ul role="list" class="workspagelist">
        <li class="serviceslist">WordPress</li>
        <li class="serviceslist">Webflow</li>
        <li class="serviceslist">Microsoft 365</li>
        <li class="serviceslist">GitHub</li>
...
<div class="horizontal-scroll-wrapper">
  <div class="horizontal-scroll-content">
    ...
    <!-- 5 --><a href="#" data-cal-link="hello.mattsmall/15min" data-cal-namespace="" data-cal-config='{"layout":"month_view"}' data-w-id="e6f4876e-cf7c-b96f-6b87-c269130a7ac0" class="section featured w-inline-block"><img class="featureimg" src="/wp-content/themes/commontheme/images/work-commonwealth-creative-novafr-5_1.webp" alt="" style="opacity:0" sizes="(max-width: 479px) 79vw, (max-width: 767px) 87vw, (max-width: 991px) 90vw, 65vw" data-w-id="e6f4876e-cf7c-b96f-6b87-c269130a7ac1" loading="lazy"></a><!-- 5 -->
